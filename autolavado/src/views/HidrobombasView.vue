    ...
    <div class="container">
        ...
        <div class="productos-section">
            <div class="productos-header">
                <h1>💦 Hidrobombas y Accesorios</h1>
                <p class="subtitle">Equipo de alta presión para limpieza profesional</p>
            </div>
    ...
    methods: {
        async cargarProductos() {
            ...
            try {
                ...
                this.productos = todosLosProductos.filter((p) => p.id_categoria === 1)
            } catch (error) {
