    ...
    <div class="container">
        ...
        <div class="productos-section">
            <div class="productos-header">
                <h1>🎨 Pinturas para Autos</h1>
                <p class="subtitle">Colores originales con resistencia garantizada</p>
            </div>
    ...
    methods: {
        async cargarProductos(forzarRecarga = false) {
            ...
            try {
                ...
                this.productos = todosLosProductos.filter((p) => p.id_categoria === 2)
            } catch (error) {
        ...
        agregarAlCarrito(producto) {
            const item = {
                id_producto: `${producto.id_categoria}-${producto.id_pintura}`,
