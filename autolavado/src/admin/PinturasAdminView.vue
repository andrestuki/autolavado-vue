<template>
  ...
  <div class="editar-productos">
    <h1 class="titulo-principal"> Gestión de pinturas</h1>
    ...
    <div v-if="pinturaseleccionado" class="formulario-editar">
      ...
      <div class="form-grid">
        <input v-model="pinturaseleccionado.nombre" class="input-texto" placeholder="Nombre" />
        <input v-model.number="pinturaseleccionado.precio" class="input-texto" type="number" placeholder="Precio" />
        <input v-model.number="pinturaseleccionado.cantidad" class="input-texto" type="number" placeholder="Stock" />
      </div>
      <div class="btn">
    ...
    <div v-else-if="busquedaRealizada" class="mensaje-error">
      <p>pintura no encontrada.</p>
    </div>

    <div class="tabla-contenedor">
      <h3 class="subtitulo"> Lista de pinturas</h3>
      <table class="tabla-productos">
        ...
        <tbody>
          <tr v-for="p in pinturas" :key="p.id_pintura">
            <td>{{ p.id_pintura }}</td>
            <td>{{ p.nombre }}</td>
    ...
    <div class="admin-agregar">
      ...
      <form @submit.prevent="agregarProducto">
        <input v-model="nuevo.id_pintura" type="number" placeholder="ID" required />
