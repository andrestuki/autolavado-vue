<template>
  ...
  <div class="editar-productos">
    <h1 class="titulo-principal"> Gestión de shampoos</h1>
    ...
    <div v-if="shampooseleccionado" class="formulario-editar">
      ...
      <div class="form-grid">
        <input v-model="shampooseleccionado.nombre" class="input-texto" placeholder="Nombre" />
        <input v-model.number="shampooseleccionado.precio" class="input-texto" type="number" placeholder="Precio" />
        <input v-model.number="shampooseleccionado.cantidad" class="input-texto" type="number" placeholder="Stock" />
      </div>
      <div class="btn">
    ...
    <div v-else-if="busquedaRealizada" class="mensaje-error">
      <p>shampoo no encontrada.</p>
    </div>

    <div class="tabla-contenedor">
      <h3 class="subtitulo"> Lista de shampoos</h3>
      <table class="tabla-productos">
        ...
        <tbody>
          <tr v-for="p in shampoos" :key="p.id_shampoo">
            <td>{{ p.id_shampoo }}</td>
            <td>{{ p.nombre }}</td>
    ...
    <div class="admin-agregar">
      ...
      <form @submit.prevent="agregarProducto">
        <input v-model="nuevo.id_shampoo" type="number" placeholder="ID" required />
