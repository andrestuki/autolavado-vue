...
from routes import auth_routes, productos_routes, categorias_routes, pedidos_routes
import os
...
# CORS (para conectar con tu frontend Vue)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # puedes poner tu dominio aquí si quieres restringirlo
